...
<body >
		<main >
			...
			<div class="right" style="overflow: auto;margin-top: -40px;display: flex;flex-direction: column;align-content: center;justify-content: flex-start;">
					...
					<div class="message-card">
						...
						<div class="right-col">
							...
							@elseif($submission->status === 'rejected')
									<span style="color: blue; font-weight: bold;">(Rejected)</span>
