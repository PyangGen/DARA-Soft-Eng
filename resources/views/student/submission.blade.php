...
<body>
    <main>
        ...
        <div class="main" style="height: 100%; overflow: hidden;">
            <div class="left">
                ...
                <nav class="nav-links">
                    <a href="dashboard" style="font-weight: 500; font-size: 14px;">
                       <svg width="24"
                    ...
                    <a href="student/" style="font-weight: 500; font-size: 14px;">
                    ...
                    <a href="doc-status" style="font-weight: 500; font-size: 14px;">
                     ...
                     <a href="account-setting" style="font-weight: 500; font-size: 14px;">
    ...
    <label for="co_authors">Co-Authors (comma-separated):</label>
    <input id="co_authors" type="text" name="co_authors"
        style="font-weight: bold; border: 1px solid black;">
    <div id="coAuthorsError" class="error"></div>
...
/*     const dateInput = document.getElementById('publication_date').value;
    if (dateInput) {
        const today = new Date().toISOString().split('T')[0];
        if (dateInput > today) {
            document.getElementById('dateError').textContent = "Submission date cannot be in the future.";
            valid = false;
        }
    }
    const dateInput = document.getElementById('publication_date').value;
if (dateInput) {
    ...
    if (dateInput < today) {
        document.getElementById('dateError').textContent =
            "Submission date cannot be set to a past day.";
        valid = false;
    }
}
 */
